...
public class BackgroundMovingController : MonoBehaviour
{
    ...
    public int currentBeat = 0;           // index of the current beat
    public int previousBeat = 0;  // index of the last beat
    ...
    private void ChangeDirection()
    {
        ...
        {
            scrollingSpeed.x = Random.Range(-5.0f, 5.0f);
            scrollingSpeed.y = Random.Range(-5.0f, 5.0f);
        }
